            ...
            $gridColumns = [
                ...
                [
                   ...
                   // 'value' => 'id_categoria.nombre',                
                     'value' => function($model){
                        $producto = TblProductos::findOne($model->id_producto);
                ...
                [
                    ...
                    'value' => function ($model, $key, $index, $widget) {
                        return Html::a($model->existencias,  ['view', 'id_iventario' => $model->id_inventario]);
                    },
                    'filterType' => GridView::FILTER_SELECT2,
                    'filter' => ArrayHelper::map(TblInventario::find()->orderBy('existencias')->all(), 'id_inventario', 'existencias'),
                    'filterWidgetOptions' => [
                        'options' => ['placeholder' => 'Todos...'],
                        'pluginOptions' => [
                            'allowClear' => true
